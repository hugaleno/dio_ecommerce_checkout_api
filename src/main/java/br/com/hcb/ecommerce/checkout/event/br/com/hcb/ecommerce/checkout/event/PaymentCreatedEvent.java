 ...
 */
package br.com.hcb.ecommerce.checkout.event;
...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8167762786152655019L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentCreatedEvent\",\"namespace\":\"br.com.hcb.ecommerce.checkout.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]},{\"name\":\"status\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"paymentCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]}]}");
   ...
   */
  public PaymentCreatedEvent(java.lang.String checkoutCode, java.lang.Object status, java.lang.Object paymentCode) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: paymentCode = value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder newBuilder() {
    return new br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder newBuilder(br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder other) {
    if (other == null) {
      return new br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder();
    } else {
      return new br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder newBuilder(br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent other) {
    if (other == null) {
      return new br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder();
    } else {
      return new br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder setCheckoutCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder setStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.hcb.ecommerce.checkout.event.PaymentCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
    ...
    public PaymentCreatedEvent build() {
      try {
        ...
        record.paymentCode = fieldSetFlags()[2] ? this.paymentCode :  defaultValue(fields()[2]);
        return record;
